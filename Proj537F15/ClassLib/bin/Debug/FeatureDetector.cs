...
namespace Detector
{
    public class FeatureDetector
    {
        ...
        public Matrix<double> features = new Matrix<double>(10,1);
        ...
        public int DetectFeature(Image<Bgr, byte> img)
        {
            ...
            features = new Matrix<double>(c, 1);
            for (int i = 0; i < c; i++) { features[i,0] = ftr[i]; }
            return c;
        }
        ...
        public void DetectBGR(Image<Bgr,byte> img)
        {
            ...
            ft_bgr[0] = bgr[0] / (sum+1);
            ft_bgr[1] = bgr[1] / (sum+1);
            ft_bgr[2] = bgr[2] / (sum+1);
        }
